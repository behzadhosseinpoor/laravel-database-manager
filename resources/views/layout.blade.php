...
<head>
    ...
    <title>Horizon{{ config('database-manager.name') ? ' - ' . config('database-manager.name') : '' }}</title>

    <!-- Style sheets-->
    <link rel="preconnect" href="https://fonts.bunny.net">
    <link href="https://fonts.bunny.net/css?family=figtree:300,400,500,600" rel="stylesheet"/>
    {{ BehzadHosseinPoor\DatabaseManager\DatabseManager::css() }}
    {{ BehzadHosseinPoor\DatabaseManager\DatabseManager::js() }}
</head>
<body>
